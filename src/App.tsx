...
const PRODUCTS: Product[] = [
  ...
  {
    id: "prod-b24",
    name: "Boys' Classic Royal Jodhpuri Suit",
    category: "Boys' Collection (Age 0-18 Years)",
    price: 3599,
    rating: 4.9,
    reviews: 83,
    description: "Tailored forest green velvet Jodhpuri suit with polished golden buttons, perfect for wedding functions.",
    textureType: "bandhgala",
    colorPalette: { primary: "#064E3B", secondary: "#FAF6F0", accent: "#D4AF37" },
    imageUrl: "/kid_boy_3.png"
  },
  {
    id: "prod-b25",
    name: "Boys' Block Printed Cotton Sherwani Set",
    category: "Boys' Collection (Age 0-18 Years)",
    price: 2999,
    rating: 4.8,
    reviews: 47,
    description: "Traditional Ajrakh block printed cotton sherwani paired with comfortable cotton pyjamas.",
    textureType: "sherwani",
    colorPalette: { primary: "#7F1D1D", secondary: "#FAF6F0", accent: "#D4AF37" },
    imageUrl: "/kid_boy_2.png"
  },
  {
    id: "prod-b28",
    name: "Boys' Brocade Border Kurta Dhoti Set",
    category: "Boys' Collection (Age 0-18 Years)",
    price: 2299,
    rating: 4.9,
    reviews: 61,
    description: "Traditional maroon silk kurta featuring golden brocade borders, paired with a ready-to-wear readymade dhoti.",
    textureType: "kurta",
    colorPalette: { primary: "#7F1D1D", secondary: "#FAF6F0", accent: "#D4AF37" },
  ...
  {
    id: "prod-b31",
    name: "Boys' Royal Indigo Printed Cotton Set",
    category: "Boys' Collection (Age 0-18 Years)",
    price: 1499,
    rating: 4.9,
    reviews: 36,
    description: "Premium indigo dyed cotton shirt-collar kurta featuring hand-blocked Dabu prints.",
    textureType: "kurta",
    colorPalette: { primary: "#1E3A8A", secondary: "#FAF6F0", accent: "#D4AF37" },
  ...
  {
    id: "prod-g28",
    name: "Girls' Royal Gota Patti Lehenga Choli",
    category: "Girls' Collection (Age 0-13 Years)",
    price: 3299,
    rating: 4.9,
    reviews: 48,
    description: "Exquisite crimson red silk lehenga choli set detailed with premium hand-embroidered Rajasthani Gota Patti border work.",
    textureType: "saree",
  ...
  {
    id: "prod-g29",
    name: "Girls' Bandhani Print Silk Anarkali Suit",
    category: "Girls' Collection (Age 0-13 Years)",
    price: 2499,
    rating: 4.8,
    reviews: 63,
    description: "Traditional tie-dye yellow and pink Bandhani silk Anarkali kurta set with a sheer net dupatta.",
    textureType: "kurta",
    colorPalette: { primary: "#EAB308", secondary: "#EC4899", accent: "#D4AF37" },
    imageUrl: "/kid_girl_3.png"
  },
  {
    id: "prod-g30",
    name: "Girls' Banarasi Brocade Pavadai Lehenga",
    category: "Girls' Collection (Age 0-13 Years)",
    price: 2999,
    rating: 4.9,
    reviews: 71,
    description: "Stunning emerald green Banarasi silk Pavadai lehenga featuring authentic woven gold zari checks.",
    textureType: "saree",
    colorPalette: { primary: "#064E3B", secondary: "#FAF6F0", accent: "#D4AF37" },
  ...
  {
    id: "prod-g31",
    name: "Girls' Jaipur block printed Cotton Sharara",
    category: "Girls' Collection (Age 0-13 Years)",
    price: 1999,
    rating: 4.7,
    reviews: 55,
    description: "Sleek peach block printed cotton short kurta paired with a flared matching sharara and cotton dupatta.",
    textureType: "kurta",
    colorPalette: { primary: "#FDBA74", secondary: "#FAF6F0", accent: "#D4AF37" },
