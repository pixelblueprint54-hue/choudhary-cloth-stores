...
export const AIDarbarStylist: React.FC<AIDarbarStylistProps> = ({ isOpen, onClose }) => {
  ...
  const responses: Record<string, string> = {
    ...
    price: "Hukum, since all our royal garments are custom-tailored to perfection, the pricing is provided upon personal consultation, fabric choice, and measurement specification, sa.",
